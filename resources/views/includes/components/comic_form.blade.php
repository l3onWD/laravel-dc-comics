    ...
    <div class="row">
        ...
        <div class="col-6">
            <div class="mb-3">
                ...
                <input type="number" class="form-control @error('price') is-invalid @enderror" id="price"
                    name="price" min="0" value="{{ old('price', $comic->price) ?? '0' }}" step="0.01">
                @error('price')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
        ...
        <div class="col-6">
            <div class="mb-3">
                ...
                <input type="date" class="form-control @error('sale_date') is-invalid @enderror" id="sale-date"
        ...
        <div class="col-12">
            <div class="mb-5">
                ...
                <input type="text" class="form-control @error('writers') is-invalid @enderror" id="writers"
                    name="writers" placeholder="Comic Writers" value="{{ old('writers', $comic->writers) }}">
                @error('writers')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
